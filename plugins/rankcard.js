...
m.reply('_Sedang mengecek database..._\n*Mohon tunggu sekitar 1 menit*')
let res = `https://api.lolhuman.xyz/api/rank?apikey=rey2k21&img=${ppq}&background=https://i.ibb.co/p4sFTGV/20220127-122720.jpg&username=${name}&level=${level}&ranking=${role}&currxp=${exp}&xpneed=${max}`
let caption = `┏━━━ꕥ〔 *Your Profile!* 〕ꕥ━⬣
┃✾ *Name:* ${name}
┃✾ *Role :* ${role}
┃✾ *Level:* ${level}
┃✾ *Exp :* ${exp} --> ${max}
